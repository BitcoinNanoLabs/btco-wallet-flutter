...
class AppLocalization {
  ...
  String get sendAmountConfirm {
    return Intl.message("Send %1 BTCO",
  ...
  String get minimumSend {
    return Intl.message("Minimum send amount is %1 BTCO",
  ...
  String get notificationTitle {
    return Intl.message("Received %1 BTCO",
  ...
  String get transferNoFunds {
    return Intl.message("This seed does not have any BTCO on it",
  ...
  String get transferConfirmInfo {
    return Intl.message(
        "A wallet with a balance of %1 BTCO has been detected.\n",
  ...
  String get newAccountIntro {
    return Intl.message(
        "This is your new account. Once you receive BTCO, transactions will show up like this:",
  ...
  String get eulaUrl {
    return 'https://bitcoinnano.org/eula_btco.html';
  }

  String get privacyUrl {
    return 'https://bitcoinnano.org/privacy.html';
  }
