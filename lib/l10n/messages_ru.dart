...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Добро пожаловать в Infinitum.Когда вы получите или отправите BTCO,это будет отображено ниже."),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("Выход из системы приведёт к удалению Seed и всех связанных с Infinitum данных с этого устройства.Если ваш Seed не будет скопирован,вы больше никогда не сможете получить доступ к своим средствам."),
    ...
    "minimumSend" : MessageLookupByLibrary.simpleMessage("Минимум сумма отправки % 1 BTCO "),
    ...
    "newAccountIntro" : MessageLookupByLibrary.simpleMessage("Это ваш новый аккаунт. Как только вы получите BTCO, транзакции будут выглядеть так:"),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("Откройте Infinitum для просмотра."),
    "notificationHeaderSupplement" : MessageLookupByLibrary.simpleMessage("Нажмите чтобы открыть"),
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Получено %1 BTCO"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("Вам больше не понадобится пароль, чтобы открыть Infinitum."),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("Этот пароль потребуется для открытия Infinitum."),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("Требуется пароль для открытия Infinitum?"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("Отправить %1 BTCO"),
    ...
    "shareNatrium" : MessageLookupByLibrary.simpleMessage("Поделиться Infinitum"),
    "shareNatriumText" : MessageLookupByLibrary.simpleMessage("Оцените Infinitum! Лучший Android кошелёк BTCO!"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 BTCO успешно переведены в Infinitum кошелёк.\n"),
    "transferConfirmInfo" : MessageLookupByLibrary.simpleMessage("Обнаружен кошелёк с балансом %1 BTCO.\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("Этот процесс переведёт средства с бумажного кошелька на ваш Infinitum кошелёк.\n\nНажмите кнопку \"%1\" чтобы начать."),
    ...
    "transferNoFunds" : MessageLookupByLibrary.simpleMessage("На этом seed нет BTCO."),
    "transferQrScanError" : MessageLookupByLibrary.simpleMessage("Этот QR не содержит действительного seed"),
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("Сканировать BTCO \nseed или закрытый ключ"),
    "unconfirmed" : MessageLookupByLibrary.simpleMessage("неподтвержденный"),
    "unlock" : MessageLookupByLibrary.simpleMessage("Открыть"),
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("Аутентификация для разблокировки Infinitum"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("Введите PIN , для разблокировки Infinitum"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("Добро пожаловать в Infinitum. Вы можете создать новый кошелек или импортировать уже существующий."),
